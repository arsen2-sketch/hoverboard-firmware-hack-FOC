...
#define FIELD_WEAK_EN   1            // [-] Field Weakening / Phase Advance enable flag: 0 = Disabled (default), 1 = Enabled
...
#define ADC_PROTECT_THRESH        500     // ADC Protection threshold below/above the MIN/MAX ADC values
